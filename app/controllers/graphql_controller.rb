...
class GraphqlController < ApplicationController
  ...
  def prepare_variables(variables_param) # rubocop:disable Metrics/CyclomaticComplexity
  ...
  def current_user
    User.find(doorkeeper_token.resource_owner_id) if doorkeeper_token&.resource_owner_id.present?
  end
end
